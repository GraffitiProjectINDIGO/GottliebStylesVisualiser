...
<li><a href="https://github.com/GraffitiProjectINDIGO/GottliebStyles/archive/refs/heads/main.zip">Download</a> <b>InstallerGSV1.0.exe</b>. After unzipping, double-click this file to start installing GSV and the MATLAB R2022a Runtime Environment (v9.12). In this way, MATLAB is not needed to work with GSV. However, the file was compiled on Windows 10 and will not work on MacOS and Linux systems.</li>
